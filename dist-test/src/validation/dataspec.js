...
export function validateDataSpec(inputs, fields) {
    const errors = [];
    for (const f of fields) {
        ...
        if (missing)
            continue; // optional, not provided — skip further checks
        switch (f.type) {
            case "string": {
...
export function validateBackendOutput(output) {
...
export function validateFlowShape(steps) {
    const typed = steps;
