...
import {
  ...
  findInlineClassDefinitionFields,
  FORBIDDEN_FLOW_KEYS,
} from "../../src/security/class_definition_guard.js";
...
test("CFV-10: refuses flow with class_definition_inline", () => {
  ...
  const details = r!.details as { forbidden_fields: string[]; http_status_equivalent: number };
