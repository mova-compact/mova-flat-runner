...
test("validateDataSpec — XSS string in URL field rejected", () => {
  const fields = [{ field: "url", type: "string" as const, format: "uri", required: true, description: "" }];
...
test("validateDataSpec — empty string treated as missing for required", () => {
  const fields = [{ field: "name", type: "string" as const, required: true, description: "" }];
...
test("validateDataSpec — NaN rejected as number", () => {
  const fields = [{ field: "score", type: "number" as const, required: true, description: "" }];
...
test("validateDataSpec — multiple errors reported together", () => {
  const fields = [
    { field: "url",   type: "string" as const, format: "uri", required: true, description: "" },
    { field: "score", type: "number" as const,                required: true, description: "" },
    { field: "fw",    type: "string" as const,                required: true, description: "", enum: ["a", "b"] },
  ];
